                          ...
                          <div class="tab-content">
                            ...
                            >
                              ...
                              <div class="login-with-sites text-center">
                                ...
                                <button class="btn-twitter login-icons btn-lg">
          ...
          <div class="container">
            <div class="section-header">
              <h5 class="heading-design-h5">
                ...
                <a class="float-right text-secondary" href="shop.html">
                  View All
                </a>
              </h5>
            </div>
        ...
        <section class="offer-product">
          <div class="container">
            <div class="row no-gutters">
              <div class="col-md-6">
                <a href="#">
                  <img class="img-fluid" src="img/ad/1.jpg" alt="" />
                </a>
              </div>
              <div class="col-md-6">
                <a href="#">
                  <img class="img-fluid" src="img/ad/2.jpg" alt="" />
                </a>
              </div>
            </div>
          </div>
