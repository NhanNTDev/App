...
import 'package:delivery_driver_application/src/feature/screen/shipping_task/cancel_task/shipping_cancel_task_bloc.dart';
...
import 'components/list_shipping_cancel_tasks.dart';

class ShippingCancelTaskScreen extends StatefulWidget {
  const ShippingCancelTaskScreen({Key? key}) : super(key: key);

  @override
  _ShippingCancelTaskScreenState createState() =>
      _ShippingCancelTaskScreenState();
}

class _ShippingCancelTaskScreenState extends State<ShippingCancelTaskScreen> {
    ...
    if (deliveryDriverId != '') {
      return Expanded(
          child: SingleChildScrollView(
              child: BlocProvider(
        create: (_) => ShippingCancelTaskBloc(
            httpClient: http.Client(), driverId: deliveryDriverId)
          ..add(ShippingCancelFetched()),
        child: ListShippingCancelTask(
