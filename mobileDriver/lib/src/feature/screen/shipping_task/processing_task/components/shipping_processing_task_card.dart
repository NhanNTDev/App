...
class ShippingProcessingTaskCard extends StatefulWidget{
  final DeliveryShipping deliveryShipping;
  final void Function()? onAccept;
  final void Function()? onCancel;

  const ShippingProcessingTaskCard({Key? key, required this.deliveryShipping, this.onCancel, this.onAccept}) : super(key: key);

  @override
  _ShippingProcessingTaskCardState createState() => _ShippingProcessingTaskCardState();
}
...
class _ShippingProcessingTaskCardState extends State<ShippingProcessingTaskCard> {
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      SizedBox(width: 5,),
                                      Text(items.orders[index].customerName,
                                          style: TextStyle(
                                              fontFamily: 'BeVietnamPro',
                                              fontWeight: FontWeight.w500,
                                              // fontSize: 15.sp,
                                      ...
                                      return Container(
                                          ...
                                          child: Column(
                                            children: [
                                                                    ...
                                                                    actions: <Widget>[
                                                                      ...
                                                                      TextButton(
                                                                        onPressed: () {
                                                                          ...
                                                                          setState(() {
                                                                            isLoading = true;
                                                                            updateStatus(items.orders[index].id as int, 7,items.orders[index]);
                                                                          });
                                              ...
                                              else if(items.orders[index].status == "Đã hoàn thành")
                                                ...[Container(
