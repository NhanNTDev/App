...
class CancelTaskCard extends StatefulWidget{
  final CollectDestination collectOrder;

  const CancelTaskCard({Key? key, required this.collectOrder}) : super(key: key);

  @override
  _CancelTaskCardState createState() => _CancelTaskCardState();
}

class _CancelTaskCardState extends State<CancelTaskCard> {
  @override
  void initState() {
    super.initState();
  }
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  // Text('Lí do: ', style: TextStyle(
                  //     fontFamily: 'BeVietnamPro',
                  //     fontWeight: FontWeight.w400,
                  //     // fontSize: 15.sp,
                  //     fontSize: 12.sp,
                  //     color: Colors.grey)),
                  // Text('Đơn hàng không đạt tiêu chuẩn', style: TextStyle(
                  //     fontFamily: 'BeVietnamPro',
                  //     fontWeight: FontWeight.w400,
                  //     // fontSize: 15.sp,
                  //     fontSize: 12.sp,
