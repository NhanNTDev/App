...
namespace DiCho.DataService.AutoMapperModule
{
    public static class FarmOrderModule
    {
        public static void ConfigFarmOrderModule(this IMapperConfigurationExpression mc)
        {
            ...
            mc.CreateMap<FarmOrder, FarmOrderMapOrderGroupDataModel>();
            mc.CreateMap<FarmOrderMapOrderGroupDataModel, FarmOrder>();

            mc.CreateMap<FarmOrder, FarmOrderCollectionGroup>();
            mc.CreateMap<FarmOrderCollectionGroup, FarmOrder>();
            ...
            mc.CreateMap<FarmOrder, FarmOrderCollectionModel>();
            mc.CreateMap<FarmOrderCollectionModel, FarmOrder>();
