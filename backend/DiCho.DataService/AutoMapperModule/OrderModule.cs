...
namespace DiCho.DataService.AutoMapperModule
{
    public static class OrderModule
    {
        public static void ConfigOrderModule(this IMapperConfigurationExpression mc)
        {
            ...
            mc.CreateMap<Order, OrderGroupDataModel>();
            mc.CreateMap<OrderGroupDataModel, Order>();

            mc.CreateMap<Order, OrderGroupDeliveryModel>();
            mc.CreateMap<OrderGroupDeliveryModel, Order>();

            mc.CreateMap<Order, OrderGroupDeliveryViewModel>();
            mc.CreateMap<OrderGroupDeliveryViewModel, Order>();
            ...
            mc.CreateMap<Order, OrderUpdateFarmOrderModel>();
            mc.CreateMap<OrderUpdateFarmOrderModel, Order>();
