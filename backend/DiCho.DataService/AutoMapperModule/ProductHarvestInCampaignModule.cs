...
namespace DiCho.DataService.AutoMapperModule
{
    public static class ProductHarvestInCampaignModule
    {
        public static void ConfigProductHarvestInCampaignModule(this IMapperConfigurationExpression mc)
        {
            ...
            mc.CreateMap<ProductHarvestInCampaign, ProductHarvestInCampaign>();
            mc.CreateMap<ProductHarvestInCampaign, ProductHarvestInCampaign>();
            ...
            mc.CreateMap<ProductHarvestInCampaign, ProductHarvestInCampaignMapEndTimeModel>();
            mc.CreateMap<ProductHarvestInCampaignMapEndTimeModel, ProductHarvestInCampaign>();
            ...
            mc.CreateMap<ProductHarvestInCampaign, ProductHarvestInCampaignMapGroupOrderDataModel>();
            mc.CreateMap<ProductHarvestInCampaignMapGroupOrderDataModel, ProductHarvestInCampaign>();
            ...
            mc.CreateMap<ProductHarvestInCampaign, ProductHarvestMapToFarmInCampaign>();
            mc.CreateMap<ProductHarvestMapToFarmInCampaign, ProductHarvestInCampaign>();
