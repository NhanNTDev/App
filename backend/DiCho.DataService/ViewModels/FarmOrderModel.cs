...
namespace DiCho.DataService.ViewModels
{
    ...
    public class FarmOrderCollectionGroup
    {
        public int? Id { get; set; }
        public string Code { get; set; }
        public double Total { get; set; }
        ...
        public virtual FarmNameModel Farm { get; set; }
        public virtual ICollection<ProductHarvestOrderOfFarmCollectionModel> ProductHarvestOrders { get; set; }
    }
    ...
    public class FarmOrderCollectionModel
    {
        public int? Id { get; set; }
        public string Code { get; set; }
        public string Status { get; set; }
    ...
    public class FarmOrderGroupFarm
    {
        ...
        public List<FarmCollectionModel> Farms { get; set; }
    }
    ...
    public class FarmOrderDetailDataModel
    {
        ...
        public int? OrderId { get; set; }
        public string DriverId { get; set; }
        public FarmMapNotiModel Farm { get; set; }
    ...
    public class DeliveryOfOrderModel
    {
        public string DeliveryCode { get; set; }
        public double TotalWeight { get; set; }
        public string DriverId { get; set; }
        public string DriverName { get; set; }
        public List<OrderGroupCustomerDeliveryModel> Orders { get; set; }
    }

    public class CollectionOfFarmOrderDetailModel
    {
        public string CollectionCode { get; set; }
        public double TotalWeight { get; set; }
        public string DriverId { get; set; }
    ...
    public class CollectionOfFarmForWarehouseModel
    {
        public string CollectionCode { get; set; }
        public double TotalWeight { get; set; }
        public string DriverId { get; set; }
    ...
    public class FarmOrderMapOrderGroupDataModel
    {
        public int Id { get; set; }
        public virtual ICollection<ProductHarvestOrderMapGroupOrderDataModel> ProductHarvestOrders { get; set; }
    }
}
