...
namespace DiCho.DataService.ViewModels
{
    ...
    {
        public int Id { get; set; }
        public double WeightOfOrder { get; set; }
        public string CustomerName { get; set; }
        public string Code { get; set; }
        public double Total { get; set; }
        public double ShipCost { get; set; }
    ...
    public class OrderUpdateFarmOrderModel
    {
        public int? Id { get; set; }
        public int? Status { get; set; }
        public virtual ICollection<FarmOrderUpdateModel> FarmOrders { get; set; }
    }

    public class OrderGroupDataModel
    {
        public int? Id { get; set; }
        public string Address { get; set; }
        public int? DeliveryZoneId { get; set; }
        public virtual ICollection<FarmOrderMapOrderGroupDataModel> FarmOrders { get; set; }
    }

    public class OrderGroupCustomerDeliveryModel
    {
        public string Address { get; set; }
        public double TotalWeight { get; set; }
        public List<OrderGroupDeliveryModel> Orders { get; set; }
    }

    public class OrderGroupDeliveryModel
    {
        public int Id { get; set; }
        public string Address { get; set; }
        public double Weight { get; set; }
    ...
    public class OrderGroupCustomerDeliveryViewModel
    {
        public string DeliveryCode { get; set; }
        public double TotalWeight { get; set; }
        public string DriverId { get; set; }
        ...
        public List<OrderGroupCustomerViewModel> Addresses { get; set; }
    }

    public class OrderGroupCustomerViewModel
    {
        public string Address { get; set; }
        public double Weight { get; set; }
        public List<OrderGroupDeliveryViewModel> Orders { get; set; }
    }

    public class OrderGroupDeliveryViewModel
    {
        public int Id { get; set; }
        public string CustomerName { get; set; }
        public string Code { get; set; }
    ...
    public class OrderGroupDeliveryForDriverViewModel
    {
        public string DeliveryCode { get; set; }
        public double TotalWeight { get; set; }
        public List<OrderGroupForDriverViewModel> Addresses { get; set; }
    }

    public class OrderGroupForDriverViewModel
    {
        public string Address { get; set; }
        public double Weight { get; set; }
        public List<OrderForDriverModel> Orders { get; set; }
    }
}
