...
namespace DiCho.DataService.ViewModels
{
    ...
    public class ProductHarvestMapToFarmInCampaign
    {
        public int Id { get; set; }
        public string ProductName { get; set; }
        public string Unit { get; set; }
    ...
    public class ProductHarvestInCampaignMapGroupOrderDataModel
    {
        public int Id { get; set; }
        public double ValueChangeOfUnit { get; set; }
    }

    public class ProductHarvestInCampaignMapEndTimeModel
    {
        public int Id { get; set; }
        public string ProductName { get; set; }
        public string Unit { get; set; }
        ...
        public int? HarvestId { get; set; }
        public int? CampaignId { get; set; }
        public virtual ProductHarvestUpdateModel Harvest { get; set; }
    }
}
