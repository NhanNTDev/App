...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Post>(entity =>
            {
                ...
                entity.Property(e => e.FarmName).HasMaxLength(256);
            ...
            modelBuilder.Entity<Shipment>(entity =>
            {
                ...
                entity.HasOne(d => d.Driver)
                    ...
                    .HasConstraintName("FK_Shipment_AspNetUsers");
            });
            ...
            modelBuilder.Entity<UserFollow>(entity =>
            {
                ...
                entity.Property(e => e.FollowerImage).HasMaxLength(500);

                entity.Property(e => e.FollowerName).HasMaxLength(256);

                entity.Property(e => e.FollowingId).HasMaxLength(450);

                entity.Property(e => e.FollowingImage).HasMaxLength(500);

                entity.Property(e => e.FollowingName).HasMaxLength(256);

                entity.HasOne(d => d.Follower)
                    .WithMany(p => p.UserFollows)
                    .HasForeignKey(d => d.FollowerId)
                    .HasConstraintName("FK_UserFollow_AspNetUsers");
            });
            ...
            modelBuilder.Entity<WareHouse>(entity =>
            {
                ...
                entity.HasOne(d => d.WarehouseManager)
