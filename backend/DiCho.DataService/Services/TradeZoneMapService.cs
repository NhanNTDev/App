...
namespace DiCho.DataService.Services
{
    public partial interface ITradeZoneMapService
    {
        ...
        Task<List<Zones>> GetZonesForCampaignDeliveryZone();
        Task<List<Zones>> GetZonesForCampaignZone();
    }
    ...
    public partial class TradeZoneMapService : ITradeZoneMapService
    {
        ...
        public async Task<List<Zones>> GetZonesForCampaignDeliveryZone()
        {
            var zones = await GetListZone();
            var data = new List<Zones>();
        ...
        public async Task<List<Zones>> GetZonesForCampaignZone()
        {
            var zones = await GetListZone();
            var data = new List<Zones>();
            foreach (var zone in zones)
