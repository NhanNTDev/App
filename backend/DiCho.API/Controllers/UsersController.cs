...
namespace DiCho.API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [MapToApiVersion("1")]
        public async Task<IActionResult> UpdatePublished(string id, AspNetUserUpdatePublisedModel modelInput)
        {
            return Ok(await _jwtService.UpdatePublished(id, modelInput));
        }
    }
}
