...
namespace DiCho.API.Controllers
{
    ...
    public partial class ShipmentsController : ControllerBase
    {
        ...
        {
            return Ok(_vehicleRoutingService.TasksOfDriver(driverId));
        }
        ...
        [MapToApiVersion("1")]
        public async Task<IActionResult> GetShipmentForWarehouseManager(int warehouseId, bool assigned)
        {
            return Ok(await _shipmentService.GetShipmentForWarehouseManager(warehouseId, assigned));
        }
