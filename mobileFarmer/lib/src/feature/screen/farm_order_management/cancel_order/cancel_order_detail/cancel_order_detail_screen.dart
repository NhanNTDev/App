...
class CancelOrderDetailScreen extends StatefulWidget {
  ...
  const CancelOrderDetailScreen({Key? key, required this.farmOrderId}) : super(key: key);

  @override
  _CancelOrderDetailScreenState createState() =>
      _CancelOrderDetailScreenState();
}

class _CancelOrderDetailScreenState
    extends State<CancelOrderDetailScreen> {
