...
class ProcessingOrderCard extends StatelessWidget {
  ...
  const ProcessingOrderCard(
      {Key? key, required this.farmOrder, required this.onPressed}) : super(key: key);
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                      ...
                      style: TextStyle(
                          fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w500, fontSize: 11.sp, color: Colors.grey)),
                ),
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text('Xem chi tiết',
                          style: TextStyle(
                              fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w600, decoration: TextDecoration.underline,
                              fontSize: 12.sp, color: Color.fromRGBO(95, 212, 144, 1.0))),
                      IconWidget(icon: Iconsax.arrow_right_1, color: Color.fromRGBO(95, 212, 144, 1.0),
