...
class ConfirmedOrderDetailScreen extends StatefulWidget {
  final int farmOrderId;

  const ConfirmedOrderDetailScreen({Key? key, required this.farmOrderId})
      : super(key: key);

  @override
  _ConfirmedOrderDetailScreenState createState() =>
      _ConfirmedOrderDetailScreenState();
}

class _ConfirmedOrderDetailScreenState
    extends State<ConfirmedOrderDetailScreen> {
  final _needConfirmFarmOrderRepository = NeedConfirmFarmOrderRepository();
  int statusCode = 0;
  bool isLoading = true;
  bool isCall = false;

  FarmOrderDetail _farmOrder = FarmOrderDetail(code: '', total: 0, status: '', createAt: '', orderId: 0, customerName: '',
  ...
  Future<dynamic> updateStatusFarmOrder() async {
    ...
    setState(() {
      if (statusCode == 200) {
        ...
        Navigator.pop(context);
        Navigator.push(context, MaterialPageRoute(builder: (context) => const OrderManagementScreen(initPage: 1)),);
      } else {
        isCall = false;
  ...
  void dispose() {
    ...
    _farmOrder = FarmOrderDetail(code: '', total: 0, status: '', createAt: '', orderId: 0, customerName: '', campaignName: '',
        address: '', paymentStatus: '', paymentTypeName: '', farmName: '', harvestOrders: [], phone: '', feedBackCreateAt: '',
        content: '', star: 0, note: '');
    statusCode = 0;
    isLoading = true;
    isCall = false;
              ...
              skeleton: SkeletonItem(
                child: Column(
                  children: [
                    ...
                    SkeletonParagraph(
                      style: SkeletonParagraphStyle(
                          lines: 1, spacing: 8, lineStyle: SkeletonLineStyle(randomLength: true, height: 10,
                            borderRadius: BorderRadius.circular(0), minLength: MediaQuery.of(context).size.width / 2,)),),
                  ],
                ),
              ),
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text('Đơn hàng: ' + _farmOrder.code, style: TextStyle(
                                  fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w600,
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 5,),
                              Text(_farmOrder.status, style: TextStyle(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Text('Khách hàng: ' + _farmOrder.customerName, style: TextStyle(
                                      fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w500,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                width: 300,
                                child: Text(_farmOrder.address, style: TextStyle(
                                        fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w500,
                                        fontSize: 11.sp, color: Colors.black.withOpacity(0.8))),
                              ),
                            ],
                        ...
                        Padding(
                          ...
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Đặt hàng tại: ', style: TextStyle(
                                      fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w500,
                                      fontSize: 11.sp, color: Colors.black.withOpacity(0.8))),
                              Container(
                                width: 273,
                                child: Text(_farmOrder.farmName, style: TextStyle(
                                        fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w500,
                                        fontSize: 11.sp, color: Colors.black.withOpacity(0.8))),
                              ),
                            ],
                        ...
                        Padding(
                          ...
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Chiến dịch: ', style: TextStyle(
                                      fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w500,
                                      fontSize: 11.sp, color: Colors.black.withOpacity(0.8))),
                              Container(
                                width: 285,
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Text('Ngày đặt: ', style: TextStyle(fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w500,
                                      fontSize: 11.sp, color: Colors.black.withOpacity(0.8))),
                              _farmOrder.createAt != ''
                                  ? Text(convertFormatHour(DateTime.parse(_farmOrder.createAt)) + ' ' +
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                width: 255,
                                child: Text(_farmOrder.paymentStatus, style: TextStyle(
                                        fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w500,
                                        fontSize: 11.sp, color: Colors.black.withOpacity(0.8))),
                              ),
                            ],
                        ...
                        Padding(
                          ...
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Hình thức thanh toán: ', style: TextStyle(
                                      fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w500,
                                      fontSize: 11.sp, color: Colors.black.withOpacity(0.8))),
                              Text(_farmOrder.paymentTypeName, style: TextStyle(
                                      fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w500,
                                      fontSize: 11.sp, color: Colors.black.withOpacity(0.8))),
                            ],
                          ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Text('Sản phẩm của đơn hàng', style: TextStyle(
                                      fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w600,
                          ...
                          itemBuilder: (context, index) {
                            return Row(
                              children: <Widget>[
                                ...
                                SizedBox(width: 50),
                                Text(_farmOrder.harvestOrders[index].productName,
                                    style: TextStyle(
                                        fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w500,
                                        fontSize: 11.sp, color: Colors.black)),
                                Spacer(),
                                Text(
                                    _farmOrder.harvestOrders[index].price.toString() + " vnd",
                                    style: TextStyle(
                                        fontFamily: 'BeVietnamPro', fontWeight: FontWeight.w500,
                                        fontSize: 11.sp, color: Colors.black)),
                              ],
                          ...
                          children: [
                            Container(
                                ...
                                child: TextButton(
                                  onPressed: () {
                                    ...
                                    showDialog<String>(
                                      context: context, builder: (BuildContext context) => AlertDialog(
                                        ...
                                        content: const Text('Bạn muốn chuyển trạng thái đơn hàng này sang đang xử lí?'),
                                        actions: <Widget>[
                                          TextButton(
                                  ...
                                  child: Text('Chuyển sang trạng thái đang xử lí',
