...
class SearchMyCampaignScreen extends StatefulWidget {
  final String farmerId;

  const SearchMyCampaignScreen({Key? key, required this.farmerId})
      : super(key: key);

  @override
  _SearchMyCampaignScreenState createState() => _SearchMyCampaignScreenState();
}
...
class _SearchMyCampaignScreenState extends State<SearchMyCampaignScreen> {
  ...
  Future<void> getListJoinCampaignByName() async {
    listSearch = await _campaignRepository.getAppliedCampaignByName('', widget.farmerId);
    setState(() {
      isCall = false;
              ...
              title: Container(
                ...
                child: TextField(
                  ...
                  onChanged: (string) {
                    _debouncer.run(() {
                      setState(() {
                        listSearchCampaign = listSearch.where(
                                            ...
                                            listSearchCampaign[index].image1 != ''
                                                ? SizedBox(
                                                    ...
                                                    child: ClipRRect(
                                                      ...
                                                      child: Image.network(
                                                        listSearchCampaign[index].image1, fit: BoxFit.cover,
                                                      ),
                                                    ),
                                                  ) : Container(),
                                            SizedBox(width: 8,),
                                                ...
                                                Container(
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      ...
                                                      SizedBox(width: 4,),
                                                      Text('Các nông trại đã tham gia: ',
                                                        style: TextStyle(fontFamily: 'BeVietnamPro',
                                                              ...
                                                              .map((item) =>
                                                                  Container(
                                                                    ...
                                                                    style: TextStyle(
                                                                        ...
                                                                        fontSize: 11.sp,
                                                                        color: const Color.fromRGBO(61, 55, 55, 0.7)),
                                                                  ))).toList()),
                                                ),
                                              ],
                                            )
                                      ...
                                      onPressed: () {
                                        ...
                                        Navigator.push(context,
                                            PageTransition(curve: Curves.easeInOut,
                                                ...
                                                child: MyCampaignDetailScreen(campaignId: listSearchCampaign[index].id as int,),
