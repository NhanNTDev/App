...
class UpdateHarvestInCampaignHeader extends StatelessWidget {
  const UpdateHarvestInCampaignHeader({Key? key}) : super(key: key);
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const Spacer(),
                Text('Cập nhật sản phẩm trong chiến dịch',
                    style: TextStyle(
