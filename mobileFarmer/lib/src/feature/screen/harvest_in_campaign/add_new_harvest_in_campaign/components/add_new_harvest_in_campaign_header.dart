...
class AddNewHarvestInCampaignHeader extends StatelessWidget {
  const AddNewHarvestInCampaignHeader({Key? key}) : super(key: key);
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const Spacer(),
                Text('Thêm sản phẩm trong chiến dịch',
                    style: TextStyle(
