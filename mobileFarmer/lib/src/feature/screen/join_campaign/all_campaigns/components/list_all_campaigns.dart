...
class ListAllCampaigns extends StatefulWidget {
  final String farmerId;
  const ListAllCampaigns({Key? key, required this.farmerId}) : super(key: key);

  @override
  _ListAllCampaignsState createState() => _ListAllCampaignsState();
}

class _ListAllCampaignsState extends State<ListAllCampaigns>
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<JoinAllCampaignBloc, JoinAllCampaignState>(
  ...
  void _onScroll() {
    if (_isBottom) context.read<JoinAllCampaignBloc>().add(AllCampaignFetched());
  }
