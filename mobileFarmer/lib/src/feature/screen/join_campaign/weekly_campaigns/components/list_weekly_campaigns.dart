...
class ListWeeklyCampaigns extends StatefulWidget {
  final String farmerId;

  const ListWeeklyCampaigns({Key? key, required this.farmerId})
      : super(key: key);

  @override
  _ListWeeklyCampaignsState createState() => _ListWeeklyCampaignsState();
}

class _ListWeeklyCampaignsState extends State<ListWeeklyCampaigns>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<JoinWeeklyCampaignBloc, JoinWeeklyCampaignState>(
  ...
  void _onScroll() {
    if (_isBottom)
      context.read<JoinWeeklyCampaignBloc>().add(WeeklyCampaignFetched());
  }
