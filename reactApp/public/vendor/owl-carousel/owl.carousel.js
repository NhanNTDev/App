  ...
  (function (t, e, o) {
    var i = {
        ...
        for (
          ...
          (n += i.itemWidth),
            ...
            !0 === i.options.scrollPerPage &&
              (o = t(i.$owlItems[e]).data("owl-roundPages")) !== s &&
              ((i.pagesInArray[s] = i.positionsInArray[e]), (s = o));
      },
      ...
      gestures: function () {
        ...
        function a(e) {
          "on" === e
            ? (t(o).on(i.ev_types.move, r), t(o).on(i.ev_types.end, l))
            : "off" === e &&
              (t(o).off(i.ev_types.move), t(o).off(i.ev_types.end));
        }
        function r(a) {
          var r,
            l,
          ...
          (i.newPosX = n(p).x - s.offsetX),
            ...
            "function" == typeof i.options.startDragging &&
              !0 !== s.dragging &&
              0 !== i.newRelativeX &&
              ((s.dragging = !0), i.options.startDragging.apply(i, [i.$elem])),
            (i.newRelativeX > 8 || i.newRelativeX < -8) &&
              !0 === i.browser.isTouch &&
              (void 0 !== p.preventDefault
                ? p.preventDefault()
                : (p.returnValue = !1),
              (s.sliding = !0)),
            (i.newPosY > 10 || i.newPosY < -10) &&
              !1 === s.sliding &&
          ...
          i.$elem.on(i.ev_types.start, ".owl-wrapper", function (o) {
            ...
            if (!(i.itemsAmount <= i.options.items)) {
              ...
              !1 !== i.options.autoPlay && e.clearInterval(i.autoPlayInterval),
                !0 === i.browser.isTouch ||
                  i.$owlWrapper.hasClass("grabbing") ||
          ...
          "loaded" !== (o = t(n.$owlItems[e])).data("owl-loaded") &&
            ...
            "string" == typeof (s = o.find(".lazyOwl")).data("src")
              ? (void 0 === o.data("owl-loaded") &&
                ...
                (!0 !== n.options.lazyFollow || i >= n.currentItem) &&
                  i < n.currentItem + n.options.items &&
                  s.length &&
                  n.lazyPreload(o, s))
      ...
      lazyPreload: function (t, o) {
        ...
        "DIV" === o.prop("tagName")
          ? (o.css("background-image", "url(" + o.data("src") + ")"), (i = !0))
          : (o[0].src = o.data("src")),
          (function t() {
            (n += 1),
              s.completeImg(o.get(0)) || !0 === i
                ? a()
                : n <= 100
                ? e.setTimeout(t, 100)
                : a();
      ...
      onVisibleItems: function () {
        var e,
          o = this;
        for (
          !0 === o.options.addClassActive && o.$owlItems.removeClass("active"),
            o.visibleItems = [],
            e = o.currentItem;
